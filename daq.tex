...
required intensity. Then it starts \lascar{} in the Laser mode. The long data fragment (see Figures \ref{fig:longfraga}-\ref{fig:longfragb} in \ref{app}) is transmitted in this mode.
...
are set to the required states prior to the start of the internal calibration. The long data fragment (see Figures\ref{fig:longfraga}-\ref{fig:longfragb} in \ref{app}) is transmitted in this mode.
