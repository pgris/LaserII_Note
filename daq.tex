...
manually (in the case of the LaserAlpha run type). The short data fragment ( Fig. \ref{fig:shortfrag} in appendix 2) is transmitted in this mode.
...
required intensity. Then it starts \lascar{} in the Laser mode. The long data fragment ( Figs \ref{fig:longfraga} \ref{fig:longfragb} in appendix 2) is transmitted in this mode.
...
are set to the required states prior to the start of the internal calibration. The long data fragment ( Figs. \ref{fig:longfraga} \ref{fig:longfragb} in appendix 2) is transmitted in this mode.
...
object, described in table~\ref{tab:IS:lasIIstatus} (Appendix \ref{app:c}
