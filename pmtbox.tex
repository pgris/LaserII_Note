The PMT box (Fig. \ref{fig:laspmtbox}) comprehends two PMTs \cite{ref:pmt} used to trigger the \laserii~acquisition in the \laser~mode. It houses two electronic boards :
